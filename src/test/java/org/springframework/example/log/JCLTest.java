...
public class JCLTest {
    ...
    public void testJcl() {
        ...
        logger.getClass() = class org.apache.commons.logging.impl.Jdk14Logger
            十二月 31, 2021 4:14:51 下午 org.springframework.example.log.JCLTest printLog
            信息: info Jdk14Logger
            十二月 31, 2021 4:14:51 下午 org.springframework.example.log.JCLTest printLog
            警告: warn Jdk14Logger
            十二月 31, 2021 4:14:51 下午 org.springframework.example.log.JCLTest printLog
    ...
    public void testSpringJCL() {
        ...
        /*
            logger.getClass() = class org.apache.commons.logging.LogAdapter$JavaUtilLog
                十二月 31, 2021 4:17:59 下午 org.springframework.example.log.JCLTest printLog
                信息: info JavaUtilLog
                十二月 31, 2021 4:17:59 下午 org.springframework.example.log.JCLTest printLog
                警告: warn JavaUtilLog
                十二月 31, 2021 4:17:59 下午 org.springframework.example.log.JCLTest printLog
    ...
    public void testSpringJCL_log4j2() {
        ...
        [log4j2] 16:19:12.553 [main] INFO  org.springframework.example.log.JCLTest - info Log4jLog
        [log4j2] 16:19:12.558 [main] WARN  org.springframework.example.log.JCLTest - warn Log4jLog
        [log4j2] 16:19:12.558 [main] ERROR org.springframework.example.log.JCLTest - error Log4jLog
        [log4j2] 16:19:12.558 [main] FATAL org.springframework.example.log.JCLTest - fatal Log4jLog
         */
    }
